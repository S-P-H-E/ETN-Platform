...
"[project]/node_modules/react-local-storage-manager/dist/esm/index.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
const maybeWindow = ("TURBOPACK compile-time truthy", 1) ? void 0 : "TURBOPACK unreachable";
const localStorageChangeEventName = "localStorageChange";
function createLocalStore(key, validate, defaultValue) {
    const cache = {};
    ...
    const dispatchChange = ()=>{
        maybeWindow == null ? void 0 : maybeWindow.dispatchEvent(createLocalEvent());
    };
    ...
    const localListener = (event)=>{
        ...
        events == null ? void 0 : events.dispatchEvent(createLocalEvent());
    };
    ...
    if (maybeWindow) {
        maybeWindow == null ? void 0 : maybeWindow.addEventListener(localStorageChangeEventName, localListener);
        maybeWindow == null ? void 0 : maybeWindow.addEventListener("storage", multiTabListener);
    }
    const store = {
        read () {
            if (maybeWindow === void 0) return defaultValue;
        ...
        set (data) {
            ...
            maybeWindow == null ? void 0 : maybeWindow.localStorage.setItem(key, JSON.stringify(newValue));
            cache.value = newValue;
            dispatchChange();
        },
        remove () {
            maybeWindow == null ? void 0 : maybeWindow.localStorage.removeItem(key);
            cache.value = defaultValue;
            dispatchChange();
        },
        watch (listener) {
            const wrappedListener = ()=>listener(store.get());
            events == null ? void 0 : events.addEventListener(localStorageChangeEventName, wrappedListener);
            return ()=>{
                events == null ? void 0 : events.removeEventListener(localStorageChangeEventName, wrappedListener);
            };
        },
        use () {
            const [value, setValue] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(store.get);
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>store.watch(setValue), []);
            return value;
        },
        destroy () {
            maybeWindow == null ? void 0 : maybeWindow.removeEventListener(localStorageChangeEventName, localListener);
            maybeWindow == null ? void 0 : maybeWindow.removeEventListener("storage", multiTabListener);
        }
    };
    return store;
}
...
//# sourceMappingURL=node_modules_f7faed4d._.js.map