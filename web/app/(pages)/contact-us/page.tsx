      ...
      <div className="max-w-6xl mx-auto px-10">
          ...
          <div className="bg-[var(--foreground)] border border-[var(--border)] p-6 rounded-lg mb-8">
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                ...
                <p className="mb-2">Email: info@empoweringthenation.com</p>
                <p>Phone: +27 (0) 81 255 4567</p>
              </div>
              <div>
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12">
          <div className="bg-[var(--foreground)] border border-[var(--border)] rounded-lg p-6">
            <h3 className="text-xl font-semibold mb-4 text-white">Main Location</h3>
            <div className="mapouter">
              <div className="gmap_canvas">
                <iframe 
                  ...
                  marginHeight={0} 
                  marginWidth={0} 
                  src="https://maps.google.com/maps?width=600&amp;height=400&amp;hl=en&amp;q=-26.20444,28.04556&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"
                />
          ...
          <div className="bg-[var(--foreground)] border border-[var(--border)] rounded-lg p-6">
            <h3 className="text-xl font-semibold mb-4 text-white">Second Location</h3>
            <div className="mapouter">
              <div className="gmap_canvas">
                <iframe 
                  className="gmap_iframe" 
                  ...
                  marginHeight={0} 
                  marginWidth={0} 
                  src="https://maps.google.com/maps?width=600&amp;height=400&amp;hl=en&amp;q=-26.2025,28.0345&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"
                />
                <a href="https://embed-googlemap.com">google map embed html</a>
              </div>
              <style jsx>{`
          ...
          <div className="bg-[var(--foreground)] border border-[var(--border)] rounded-lg p-6">
            <h3 className="text-xl font-semibold mb-4 text-white">Third Location</h3>
            <div className="mapouter">
              <div className="gmap_canvas">
                <iframe 
                  className="gmap_iframe" 
                  ...
                  marginHeight={0} 
                  marginWidth={0} 
                  src="https://maps.google.com/maps?width=600&amp;height=400&amp;hl=en&amp;q=-26.1074,28.0567&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"
                />
                <a href="https://embed-googlemap.com">google map embed html</a>
              </div>
              <style jsx>{`
        ...
        <div className="bg-[var(--foreground)] border border-[var(--border)] p-8 rounded-lg">
          ...
          <div className="flex flex-wrap gap-4">
            <a href="mailto:info@empoweringthenation.com" className="bg-white text-black px-6 py-3 rounded-lg hover:scale-105 transition-transform cursor-pointer">
              Send Email
            </a>
            <a href="+27812554567" className="bg-white text-black px-6 py-3 rounded-lg hover:scale-105 transition-transform cursor-pointer">
              Call Now
            </a>
          </div>
        </div>
